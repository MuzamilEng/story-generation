    ...
    return (
        <nav className={styles.nav}>
            ...
            <div className={styles.navLinks}>
                ...
                <a href="#exercise" className={styles.navLink}>
                    Try the Exercise
                </a>
                <a href="#figure-ground" className={styles.navLink}>
                    Figure-Ground
                </a>
...
const GorillaExperiment: React.FC = () => {
    ...
    const handleShowInsight = () => {
        setShowInsight(true);
        setTimeout(() => {
            document.getElementById('insightBanner')?.scrollIntoView({ behavior: 'smooth', block: 'start' });
        }, 100);
    };
        ...
        <div className={styles.exerciseWrap}>
            <div className={styles.exHeader}>
                ...
                <p className={styles.exSub}>
                    Watch the video. Follow the instruction at the start. Don't read ahead — the experiment only works once.
                </p>
            </div>
            ...
            <div className={styles.exSteps}>
                ...
                <div className={`${styles.exStep} ${step === 1 ? styles.active : ''}`}>
                    <div className={styles.exInstruction}>
                        <div className={styles.exInstructionNum}>Your task — read this first</div>
                        <div className={styles.exInstructionText}>
                            Count how many times the players in <strong>white shirts</strong> pass the basketball. Focus only on the white team. Press play when ready.
                        </div>
                    </div>
                    ...
                    <p className={styles.videoCredit}>
                        Video by <a href="https://www.dansimons.com" target="_blank" rel="noopener">Daniel Simons</a> & Christopher Chabris · Used with permission
                    </p>

                    <div className={styles.exNav}>
                        <div className={styles.exDots}>
                            <div className={`${styles.exDot} ${step === 1 ? styles.active : ''}`} />
                            <div className={`${styles.exDot} ${step === 2 ? styles.active : ''}`} />
                            <div className={`${styles.exDot} ${step === 3 ? styles.active : ''}`} />
                        </div>
                ...
                <div className={`${styles.exStep} ${step === 2 ? styles.active : ''}`}>
                    <div className={styles.eyesClosedCard}>
                        ...
                        <div className={styles.eyesSub}>
                            While counting passes, did you notice anything unusual in the video?
                        </div>
                    </div>
                ...
                <div className={`${styles.exStep} ${step === 3 ? styles.active : ''}`}>
                    <div
                        ...
                        style={didSeeGorilla ? { background: 'rgba(45,160,80,0.15)', borderColor: 'rgba(45,160,80,0.4)' } : {}}
                    >
                        <div className={styles.revealNum} style={didSeeGorilla ? { color: '#2da050' } : {}}>
                            {didSeeGorilla ? '✓' : '🦍'}
                        </div>
    ...
    return (
        <div className={styles.illusionCard}>
            ...
            <p className={styles.illusionDesc}>
                Most people immediately see the <strong>black shapes</strong>. But look at the white space between them — there is a second image hiding in plain sight.
            </p>
            ...
            <div className={styles.illusionWrap}>
                <svg className={styles.illusionSvg} viewBox="0 0 300 320">
                    ...
                    <path d="M 0,0 L 0,320 L 75,320 L 75,295 Q 78,280 82,265 Q 86,248 84,235 Q 82,220 78,210 Q 72,195 70,178 Q 67,158 72,140 Q 78,118 88,100 Q 98,82 108,68 Q 118,54 124,42 Q 130,28 130,10 L 130,0 Z" fill="#1c1a16" />

                    {/* Right face (black silhouette) */}
                    <path d="M 300,0 L 300,320 L 225,320 L 225,295 Q 222,280 218,265 Q 214,248 216,235 Q 218,220 222,210 Q 228,195 230,178 Q 233,158 228,140 Q 222,118 212,100 Q 202,82 192,68 Q 182,54 176,42 Q 170,28 170,10 L 170,0 Z" fill="#1c1a16" />

                    {/* Face highlights */}
                    <path className={styles.faceHighlight} d="M 0,0 L 0,320 L 75,320 L 75,295 Q 78,280 82,265 Q 86,248 84,235 Q 82,220 78,210 Q 72,195 70,178 Q 67,158 72,140 Q 78,118 88,100 Q 98,82 108,68 Q 118,54 124,42 Q 130,28 130,10 L 130,0 Z" fill="rgba(192,57,43,0.25)" style={{ opacity: revealed ? 1 : 0 }} />
                    <path className={styles.faceHighlight} d="M 300,0 L 300,320 L 225,320 L 225,295 Q 222,280 218,265 Q 214,248 216,235 Q 218,220 222,210 Q 228,195 230,178 Q 233,158 228,140 Q 222,118 212,100 Q 202,82 192,68 Q 182,54 176,42 Q 170,28 170,0 Z" fill="rgba(192,57,43,0.25)" style={{ opacity: revealed ? 1 : 0 }} />

                    {/* Vase highlight */}
                    <path className={styles.vaseHighlight} d="M 130,0 Q 130,28 124,42 Q 118,54 108,68 Q 98,82 88,100 Q 78,118 72,140 Q 67,158 70,178 Q 72,195 78,210 Q 82,220 84,235 Q 86,248 82,265 Q 78,280 75,295 L 75,320 L 225,320 L 225,295 Q 222,280 218,265 Q 214,248 216,235 Q 218,220 222,210 Q 228,195 230,178 Q 233,158 228,140 Q 222,118 212,100 Q 202,82 192,68 Q 182,54 176,42 Q 170,28 170,0 Z" fill="rgba(45,106,79,0.3)" style={{ opacity: revealed ? 1 : 0 }} />

                    {/* Labels */}
                    {revealed && (
                        <>
                            <text x="38" y="160" textAnchor="middle" className={styles.revealLabelFace}>Face</text>
                            <text x="262" y="160" textAnchor="middle" className={styles.revealLabelFace}>Face</text>
                            <text x="150" y="200" textAnchor="middle" className={styles.revealLabelVase}>Vase</text>
                        </>
                    )}
                </svg>
            </div>
            ...
            {revealed && (
                <div className={`${styles.illusionAnswer} ${styles.show}`}>
                    ...
                    <div className={styles.answerInsight}>
                        Once you see both, you can never un-see them. Your brain will now alternate. This is exactly what happens when you reprogram your RAS — what was invisible becomes obvious.
                    </div>
                </div>
            )}
        </div>
...
const DuckRabbit: React.FC = () => {
    ...
    return (
        <div className={styles.illusionCard}>
            ...
            <p className={styles.illusionDesc}>
                This classic illusion — published in 1892 — shows the same outline can produce two completely different animals depending on what your brain is primed to find.
            </p>
            ...
            <div className={styles.illusionWrap}>
                <svg className={styles.illusionSvg} viewBox="0 0 300 220">
                    ...
                    <path d="M 42,72 Q 18,68 8,78 Q 0,88 8,100 Q 18,110 42,106 Q 55,102 62,95 Q 55,84 42,72 Z" fill="#1c1a16" />
                    {/* Rabbit ears */}
                    <path d="M 108,48 Q 112,20 118,4 Q 122,0 126,2 Q 130,6 128,22 Q 124,42 120,58 Q 114,54 108,48 Z" fill="#1c1a16" />
                    <path d="M 122,52 Q 130,24 138,8 Q 142,2 146,4 Q 150,8 148,24 Q 144,46 136,62 Q 130,58 122,52 Z" fill="#1c1a16" />
                    {/* Eye */}
                    <circle cx="78" cy="82" r="7" fill="white" />
                    <circle cx="78" cy="82" r="3.5" fill="#1c1a16" />

                    {/* Highlights */}
                    <ellipse className={styles.duckHighlight} cx="155" cy="130" rx="85" ry="62" fill="rgba(45,106,79,0.2)" style={{ opacity: revealed ? 1 : 0 }} />
                    <ellipse className={styles.duckHighlight} cx="90" cy="88" rx="52" ry="46" fill="rgba(45,106,79,0.2)" style={{ opacity: revealed ? 1 : 0 }} />
                    <path className={styles.duckHighlight} d="M 42,72 Q 18,68 8,78 Q 0,88 8,100 Q 18,110 42,106 Q 55,102 62,95 Q 55,84 42,72 Z" fill="rgba(45,106,79,0.35)" style={{ opacity: revealed ? 1 : 0 }} />
                    <path className={styles.rabbitHighlight} d="M 108,48 Q 112,20 118,4 Q 122,0 126,2 Q 130,6 128,22 Q 124,42 120,58 Q 114,54 108,48 Z" fill="rgba(154,111,10,0.3)" style={{ opacity: revealed ? 1 : 0 }} />
                    <path className={styles.rabbitHighlight} d="M 122,52 Q 130,24 138,8 Q 142,2 146,4 Q 150,8 148,24 Q 144,46 136,62 Q 130,58 122,52 Z" fill="rgba(154,111,10,0.3)" style={{ opacity: revealed ? 1 : 0 }} />

                    {/* Labels */}
                    {revealed && (
                        <>
                            <text x="195" y="135" textAnchor="middle" className={styles.revealDuck}>Duck body</text>
                            <text x="32" y="88" textAnchor="middle" className={styles.revealDuck}>Bill →</text>
                            <text x="148" y="30" textAnchor="middle" className={styles.revealRabbit}>↑ Ears</text>
                        </>
                    )}
                </svg>
            </div>
            ...
            {revealed && (
                <div className={`${styles.illusionAnswer} ${styles.show}`}>
                    ...
                    <div className={styles.answerInsight}>
                        In 1899, psychologist Joseph Jastrow used this to prove that perception is not passive — it is shaped entirely by what the mind expects to find.
                    </div>
                </div>
            )}
        </div>
...
const Science: React.FC = () => {
    ...
    useEffect(() => {
        ...
        link.href = "https://fonts.googleapis.com/css2?family=DM+Serif+Display:ital,wght@0,400;1,400&family=DM+Sans:opsz,wght@9..40,300;9..40,400;9..40,500&family=Lora:ital,wght@0,400;1,400&display=swap";
        link.rel = "stylesheet";
        ...
        <div className={styles.container}>
            ...
            <div className={styles.hero}>
                ...
                <h1 className={styles.heroTitle}>
                    Your brain only finds<br />
                    <em>what it's looking for.</em>
                </h1>
                <p className={styles.heroSub}>
                    There is a system in your brain that acts as a filter for all of reality — deciding what you notice, what you ignore, and ultimately what you believe is possible. Understanding it changes everything.
                </p>
            ...
            <section className={styles.section}>
                ...
                <h2 className={styles.sectionTitle}>
                    You are surrounded by more<br />than you can possibly <em>see.</em>
                </h2>
                <p className={styles.prose}>
                    Right now, your five senses are receiving approximately <strong>11 million bits of information per second</strong>. The sounds in the room, the feeling of your clothes, the temperature of the air, the light hitting objects at the edge of your vision. Your conscious mind can process roughly <strong>40 to 50 bits</strong> of that per second.
                </p>
                <p className={styles.prose}>
                    Something has to decide what makes the cut. That something is the <strong>Reticular Activating System</strong> — a network of neurons at the base of your brainstem that acts as your brain's filter, gatekeeper, and priority engine. It scans the flood of incoming information and passes through only what it has been programmed to consider relevant.
                </p>
                ...
                <p className={styles.prose}>
                    This is not a flaw. It's a remarkable efficiency system — your brain cannot consciously process everything, so it filters based on what it believes matters. The profound implication is this: <strong>change what you're programmed to look for, and you change what you see in the world around you.</strong>
                </p>
            </section>
            ...
            <section className={styles.section} id="exercise">
                ...
                <h2 className={styles.sectionTitle}>
                    Your brain deletes things<br />
                    <em>right in front of you.</em>
                </h2>
                <p className={styles.prose}>
                    This isn't subtle filtering. This is your brain completely erasing something obvious — a large, moving creature — while you're focused on something else. This is one of the most famous experiments in the history of cognitive science. It will happen to most of you right now.
                </p>
            ...
            <section className={styles.section} id="figure-ground">
                ...
                <h2 className={styles.sectionTitle}>
                    What you see depends entirely<br />on <em>what you're looking for.</em>
                </h2>
                <p className={styles.prose}>
                    The gorilla experiment showed you how your brain can erase something completely obvious. This next example shows something equally striking — two completely different realities existing in the exact same image, simultaneously. Which one you see first depends entirely on your prior programming.
                </p>
                <p className={styles.prose}>
                    This phenomenon is called <strong>figure-ground perception</strong> — the brain's tendency to separate a scene into a dominant "figure" and a background. Most people default to seeing the same thing. But the other picture was always there.
                </p>
                ...
                <div className={styles.figgroundInsight}>
                    ...
                    <div className={styles.fgiBody}>
                        ...
                        <p className={styles.fgiText}>
                            The opportunities, connections, and moments that will build your ideal life are already present in your world — just like the vase was always in the image. Your brain simply isn't programmed to notice them yet. When you listen to your story every day, you're not wishing for things to appear. You're training your brain to finally <em>see</em> what was always there.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className={styles.section} id="how">
                ...
                <h2 className={styles.sectionTitle}>
                    How listening to your story<br />
                    <em>reprograms your RAS.</em>
                </h2>
                <p className={styles.prose}>
                    Understanding the exercise above makes the ManifestMyStory method easy to understand. It isn't magic — it's applied neuroscience. Here is exactly what happens when you listen to your story every morning and night.
                </p>
            ...
            <section className={styles.section} id="research">
                ...
                <p className={styles.prose}>
                    ManifestMyStory is grounded in several well-established areas of neuroscience and cognitive psychology research.
                </p>
                ...
                <PullQuote
                    text="We are what we repeatedly think. And what we repeatedly think, we begin to see. And what we see, we act upon. Neuroscience is simply confirming what philosophers have known for centuries."
                />
            </section>
            ...
            <footer className={styles.footer}>
                <p>© 2026 ManifestMyStory · <a href="#">Privacy</a> · <a href="#">Terms</a> · <Link href="/">Home</Link></p>
            </footer>
        </div>
    );
};
