...
const SignIn: React.FC = () => {
    ...
    const handleSocial = (provider: string) => {
        ...
        alert(`OAuth for ${provider} — to be wired by developer.`);
    };
    ...
    const handleSignIn = async () => {
        ...
        try {
            ...
            // On failure (uncomment to test error state)
        ...
        <div className={styles.container}>
            ...
            <header className={styles.topbar}>
                ...
                <div className={styles.topbarRight}>
                    New here? <Link href="/account-creation">Create a free account</Link>
                </div>
            </header>
                    ...
                    {!showReset ? (
                        <div id="loginForm">
                            ...
                            <p className={styles.signupNote}>
                                Don't have an account? <Link href="/account-creation">Create one free</Link>
                            </p>
