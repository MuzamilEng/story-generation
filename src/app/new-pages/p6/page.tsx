...
import { Step, PricingPlan, Testimonial } from '../../types/home';
    ...
    return (
        <nav className={`${styles.nav} ${scrolled ? styles.scrolled : ''}`}>
            ...
            <div className={styles.navLinks}>
                ...
                <Link href="/science" className={`${styles.navLink} ${styles.navScience}`}>
                    The Science
                    <ExternalIcon />
                </Link>
            </div>
        ...
        <section className={styles.hero}>
            ...
            <div className={styles.heroContent}>
                ...
                <h1 className={styles.heroTitle}>
                    Hear the life<br />
                    <em>you're building</em><br />
                    every single day.
                </h1>

                <p className={styles.heroSub}>
                    Tell us your goals. We write a rich, personal story set in your future life —
                    then generate it as audio in your own voice. Listen every morning and night
                    to attract what you want.
                </p>

                <div className={styles.heroActions}>
                    <Link href="/goal-intake-ai" className={styles.heroPrimary}>
...
const AudioDemo: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const initialBars = Array.from({ length: waveformCount },
    ...
    return (
        <div className={styles.audioDemo}>
            ...
            <div className={styles.audioCaption}>
                This is what your finished audio sounds like — except narrated in <em>your</em> voice,
                about <em>your</em> life.
            </div>
        </div>
    );
};
    ...
    const steps: Step[] = [
        {
            ...
            description: 'A guided AI conversation draws out your vision — where you live, how you feel, who surrounds you, and what your perfect day looks like.'
        },
        {
            icon: <StarIcon />,
            title: 'We write your story',
            description: 'AI crafts a rich, sensory, first-person narrative set in your future — written as if everything you want has already come true.',
            delay: 'd1'
        },
        {
            icon: <MicIcon />,
            title: 'Hear it in your voice',
            description: 'Record a 60-second sample. We clone your voice and deliver your story as a personal audio file — narrated by you, for you.',
            delay: 'd2'
        },
        {
            icon: <ClockIcon />,
            title: 'Listen daily',
            description: 'Every morning and night, your story reprograms your subconscious to notice and attract the people, actions, and opportunities that build this life.',
            delay: 'd3'
        }
    ];
    ...
    return (
        <section className={`${styles.section} ${styles.sectionCenter}`} id="how">
            ...
            <p className={styles.secSub}>
                The entire process takes about 20 minutes. What follows can last a lifetime.
            </p>
        ...
        <section className={styles.storySection}>
            <div className={styles.storyInner}>
                <div className={`${styles.storyHed} ${styles.reveal}`}>
                    ...
                    <p>Every story is written from scratch based on your conversation. No two are the same.</p>
                </div>
                ...
                <div className={`${styles.storyDemo} ${styles.reveal}`}>
                    ...
                    <div className={styles.sdBody}>
                        <div className={styles.sdText}>
                            I open my eyes before my alarm has a chance to sound. The room is quiet except
                            for the low hum of the sea beyond the open window — that familiar rhythm that
                            has become the backdrop of my whole life here. Pale morning light falls across
                            the terracotta floor in long, warm strips, and for a moment I simply lie still
                            and let the gratitude wash through me. This is my life. This is actually my life.
                            <br /><br />
                            I rise without effort, the way I always do now. There is no resistance in the
                            morning anymore, no heaviness I used to carry. I walk barefoot across the cool
                            tiles and step onto the terrace, and there it is — the Atlantic stretching wide
                            and silver under the early sun…
                        </div>
                    ...
                    <div className={styles.sdFooter}>
                        ...
                        <Link href="/goal-intake-ai" className={styles.sdCta}>
...
const Pricing: React.FC = () => {
    const plans: PricingPlan[] = [
        {
            name: 'Free',
            price: '$0',
            description: 'Unlimited story creation & editing. Free 2-minute voice sample in your own voice.',
            cta: 'Get started'
        },
        {
            name: 'Single Story',
            price: '$4.99',
            description: 'One full audio file in your voice. No subscription — yours to keep forever.',
            cta: 'Get one audio',
            delay: 'd1'
        },
        {
            name: 'Standard',
            price: '$9.99',
            description: '5 stories/month, 60 min audio. Library grows — up to 60 stories after 1 year.',
            cta: 'Start Standard',
            featured: true,
            delay: 'd2'
        },
        {
            name: 'Power',
            price: '$19.99',
            description: '20 stories/month, 300 min audio. Library grows — up to 240 stories after 1 year.',
            cta: 'Start Power',
            delay: 'd3'
        }
    ];
    ...
    return (
        <section className={`${styles.section} ${styles.sectionCenter}`} id="pricing">
            ...
            <div className={styles.testiInner}>
                ...
                <div className={styles.testiGrid}>
                    {testimonials.map((testimonial, index) => (
                        ...
                        >
                            <div className={styles.testiStars}>{'★'.repeat(testimonial.stars)}</div>
    ...
    return (
        <section className={styles.final}>
            <div className={styles.finalContent}>
                ...
                <Link href="/goal-intake-ai" className={styles.finalBtn}>
                    Create My Story — It's Free
                    <ArrowIcon />
                </Link>
                <div className={styles.finalNote}>
                    Curious about the neuroscience? <Link href="/science">Read the science →</Link>
                </div>
            </div>
        </section>
    );
    ...
    return (
        <footer className={styles.footer}>
            ...
            <div className={styles.footLinks}>
                ...
                <Link href="/goal-intake-ai">Create my story</Link>
...
const Home: React.FC = () => {
    ...
    useEffect(() => {
        ...
        link.href = "https://fonts.googleapis.com/css2?family=DM+Serif+Display:ital,wght@0,400;1,400&family=DM+Sans:opsz,wght@9..40,300;9..40,400;9..40,500&family=Lora:ital@1&display=swap";
        link.rel = "stylesheet";
