...
export default function Home() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      if (scarcityRef.current) scarcityRef.current.style.width = `${scarcityPct}%`;
    }, 600);
      ...
      <nav className={s.nav}>
        ...
        <ul className={s.navTabs}>
          ...
          <li className={s.navDropdown}>
            <Link href="/why-it-works" className={s.navDropdownTrigger}>Why it works ▾</Link>
      ...
      <div className={s.hero}>
        ...
        <div className={s.scarcityWrap}>
          <div className={s.scarcityTop}>
            ...
            <strong className={s.scarcityTopStrong}>{memberCount} of 500</strong>
          </div>
        ...
        <div className={`${s.inviteInner} ${s.fadeIn}`}>
          ...
          <div className={s.inviteScarcity}>
            ...
            <p className={s.inviteScarcityText}>
              {memberCount} of 500 founding spots claimed <span className={s.inviteScarcitySpan}>— when filled, this closes permanently</span>
            </p>
          </div>
