          ...
          <div className={styles.cardsGrid}>
            ...
            <div className={styles.pcard}>
              ...
              <ul className={styles.flist}>
                <li className={styles.fitem}>
                  <span className={styles.fck}>✓</span>
                  <span className={`${styles.ft} ${styles.hi}`}>
                    1 personalized night story
                  </span>
                </li>
                <li className={styles.fitem}>
                  <span className={styles.fck}>✓</span>
                ...
                <li className={styles.fitem}>
                  <span className={`${styles.fck} ${styles.dim}`}>–</span>
                  <span className={styles.ft}>Downloadable MP3</span>
                </li>
                <li className={styles.fitem}>
                  <span className={`${styles.fck} ${styles.dim}`}>–</span>
                  <span className={styles.ft}>Hypnotic induction</span>
                </li>
                <li className={styles.fitem}>
                  <span className={`${styles.fck} ${styles.dim}`}>–</span>
                  <span className={styles.ft}>NLP anchor</span>
                </li>
                <li className={styles.fitem}>
                  <span className={`${styles.fck} ${styles.dim}`}>–</span>
                  <span className={styles.ft}>Binaural beats</span>
                </li>
              </ul>
            </div>
            ...
            <div className={styles.pcard}>
              ...
              <button
                ...
                className={styles.pcta}
                disabled={
                  loadingPlan === "activator" || currentPlanId === "activator"
                }
              >
                {loadingPlan === "activator"
                  ? "Connecting..."
              ...
              <ul className={styles.flist}>
                ...
                <li className={styles.fitem}>
                  <span className={styles.fck}>✓</span>
                  <span className={styles.ft}>9–11 min story</span>
                </li>
                <li className={styles.fitem}>
                  <span className={styles.fck}>✓</span>
                  <span className={styles.ft}>Listening streak tracking</span>
            ...
            <div className={`${styles.pcard} ${styles.feat}`}>
              ...
              <button
                ...
                disabled={
                  loadingPlan === "manifester" || currentPlanId === "manifester"
                }
              >
              ...
              <ul className={styles.flist}>
                ...
                <li className={styles.fitem}>
                  <span className={styles.ft}>12–15 min story</span>
                </li>
                <li className={styles.fitem}>
                  <span className={`${styles.fck} ${styles.dim}`}>–</span>
                  <span className={styles.ft}>Morning activation story</span>
                </li>
                <li className={styles.fitem}>
                  <span className={`${styles.fck} ${styles.dim}`}>–</span>
                  <span className={styles.ft}>Theta binaural beats</span>
                </li>
              </ul>
            </div>
            ...
            <div className={`${styles.pcard} ${styles.amp}`}>
              ...
              <div className={styles.priceBlock}>
                <div className={styles.pwas}>
                  {isBetaUser ? "\u00a0" : `Was $${prices.monthly.amp[1]}/mo`}
                </div>
                <div className={styles.prow}>
                  <span className={styles.pamt}>
                    {isBetaUser ? "Free" : `$${p.amp[0]}`}
                  </span>
                  <span className={styles.pper}>
                    {isBetaUser ? "trial" : "/mo"}
                  </span>
                  {!isBetaUser && (
                    <span className={styles.ftag}>Founding rate</span>
              ...
              <button
                ...
                disabled={
                  loadingPlan === "amplifier" || currentPlanId === "amplifier"
                }
              >
                {loadingPlan === "amplifier"
                  ? "Connecting..."
                  : currentPlanId === "amplifier"
                    ? "Current Plan"
                    : isBetaUser
                      ? "Start Trial"
                      : "Go all in"}
              ...
              <ul className={styles.flist}>
                <li className={styles.fitem}>
                  <span className={`${styles.fck} ${styles.pu}`}>✓</span>
                  <span className={`${styles.ft} ${styles.hi}`}>
                ...
                <li className={styles.fitem}>
                  <span className={`${styles.fck} ${styles.pu}`}>✓</span>
                  <span className={styles.ft}>16–20 min night story</span>
                </li>
                <li className={styles.fitem}>
                  <span className={`${styles.fck} ${styles.pu}`}>✓</span>
                  <span className={styles.ft}>5 min morning activation</span>
                </li>
                <li className={styles.fitem}>
                  <span className={`${styles.fck} ${styles.pu}`}>✓</span>
                  <span className={styles.ft}>
                    Anchor fired morning + night
                  </span>
                </li>
                <li className={styles.fitem}>
                  <span className={`${styles.fck} ${styles.pu}`}>✓</span>
                  <span className={styles.ft}>Priority story regeneration</span>
                </li>
              </ul>
            </div>
          </div>
