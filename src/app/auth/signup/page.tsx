...
const CreateAccountForm: React.FC = () => {
    ...
    const [strength, setStrength] = useState({ width: '0%', color: 'var(--border)', text: '' });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (result?.error) {
                ...
                // Redirect to the next page (e.g. /user/story) or dashboard
                router.push(nextUrl);
            }
        } catch (error) {
                ...
                <div className={styles.leftPreview}>
                    ...
                    <div className={styles.previewCard}>
                        <div className={styles.previewTop}>
                            <div className={styles.previewEyebrow}>Personal Manifestation Story</div>
                            <div className={styles.previewTitle}>A Day in the Life of My Highest Self</div>
                            <div className={styles.previewMeta}>1,740 words · ~13 min audio</div>
                        </div>
                        <div className={styles.previewBody}>
                            <div className={styles.previewExcerpt}>
                                I open my eyes before my alarm has a chance to sound. The room is quiet except for the low hum of the sea beyond the open window — that familiar rhythm that has become the backdrop of my whole life here…
                            </div>
                    ...
                    <div className={styles.whatYouGet}>
                        ...
                        {[
                            ...
                            <div key={i} className={styles.wygRow}>
                                <div className={styles.wygCheck}><CheckIcon /></div>
                                <span>{text}</span>
                            </div>
                        ))}
                    </div>
                ...
                <div className={styles.formCol}>
                    <div className={styles.formHeader}>
                        ...
                        <p className={styles.formSub}>
                            Create a free account to record your voice and generate your personal audio story. No credit card required.
                        </p>
                    </div>
                    ...
                    <div className={styles.socialBtns}>
                        <button className={styles.socialBtn} onClick={() => handleSocial('Google')}>
                            <div className={styles.socialIcon}><GoogleIcon /></div>
                            Continue with Google
                        </button>
                        <button className={styles.socialBtn} onClick={() => handleSocial('Apple')}>
                            <div className={styles.socialIcon}><AppleIcon /></div>
                            Continue with Apple
                        </button>
                    </div>
                    ...
                    {/* EMAIL FORM */}
                    {!showVerify ? (
                        <form className={styles.formCard} id="formCard" onSubmit={handleSubmit}>
                            {apiError && (
                                <div className={`${styles.fieldErr} ${styles.show}`} style={{ display: 'block', marginBottom: '1rem', color: 'var(--red)', fontSize: '14px', textAlign: 'center' }}>
                                    {apiError}
                                </div>
                            )}
                            <div className={styles.fieldRow}>
                                <div className={styles.field}>
                                    ...
                                    />
                                    <span className={`${styles.fieldErr} ${errors.firstName ? styles.show : ''}`}>
                            ...
                            <div className={styles.field}>
                                ...
                                />
                                <span className={`${styles.fieldErr} ${errors.email ? styles.show : ''}`}>
                            ...
                            <div className={styles.field}>
                                ...
                                <span className={`${styles.fieldErr} ${errors.password ? styles.show : ''}`}>
                            ...
                            <div className={styles.termsRow}>
                                ...
                                <label htmlFor="terms">
                                    ...
                                    <Link href="/privacy">Privacy Policy</Link>. I understand my voice sample is used only to generate my personal audio story.
                                </label>
                            </div>
                        ...
                        <div className={`${styles.verifyScreen} ${styles.show}`}>
                            ...
                            <div className={styles.verifySub}>
                                ...
                                <span className={styles.verifyEmail}>{formData.email}</span>. Click the link to confirm your account and continue.
                            </div>
